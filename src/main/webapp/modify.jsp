...
<body>
	...
	<form action="modifyOk.jsp" method="post" name="reg_frm">
		...
		이메일: <input type="text" name="email" size="30" value="<%= dto.getEmail() %>"></br><br/>
		주소: <input type="text" name="address" size="60" value="<%= dto.getAddress() %>"></br><br/>
		회원가입일 : <%= dto.getRdate() %> </br><br/><br/><br/>
